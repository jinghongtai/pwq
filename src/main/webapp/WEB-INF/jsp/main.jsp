        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <ul style="height: 100%;overflow: hidden" class="layui-nav-side layui-nav layui-nav-tree layui-bg-molv" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    <li data-name="home" class="layui-nav-item layui-nav-itemed" style="">
                    ...
                    <li data-name="component" class="layui-nav-item" style="">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="grid">
                                ...
                                <dl class="layui-nav-child">
                                    <dd data-name="list"><a lay-href="/index/personmanager">人员管理</a></dd>
                                    <dd data-name="mobile"><a lay-href="/index/resourcemanager">资源管理</a></dd>
                    ...
                    <li data-name="template" class="layui-nav-item" style="">
                    ...
                    <li data-name="app" class="layui-nav-item" style="">
                    ...
                    <li data-name="senior" class="layui-nav-item" style="">
